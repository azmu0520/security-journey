...
3. [Hash Tables & Sets](#3-hash-tables--sets)
...
- AVL: height difference ≤ 1, requires rotations
...
- Time often exponential (O(2ⁿ) or O(n!))
- DFS-based approach
...
- ✅ "I'm not sure about X, but here's what I'm thinking..."
- ✅ "Can I assume...?"
- ❌ Long silences
- ❌ "I don't know"
